...
Synthesize text to speech. Returns `audio/wav` data containing 24 kHz, 16-bit, mono PCM audio.
...
- `response_format` (optional): Only `wav` is supported. Defaults to `wav` when omitted.
