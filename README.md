...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/lixiangguo/edge-tts-worker)
...
| `response_format` | Only `wav` supported (24 kHz, 16-bit, mono PCM) | `wav` |
...
**Receive**:
- Binary messages — WAV audio chunks (24 kHz, 16-bit, mono PCM)
